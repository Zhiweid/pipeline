...
key = {'animal_id': 27424, 'session': 7, 'stack_idx': 11}
stack.Quality.populate(key, reserve_jobs=True, suppress_errors=True)
stack.RasterCorrection.populate(key, reserve_jobs=True, suppress_errors=True)
stack.MotionCorrection.populate(key, reserve_jobs=True, suppress_errors=True)
stack.Stitching.populate(key, reserve_jobs=True, suppress_errors=True)
stack.CorrectedStack.populate(key, reserve_jobs=True, suppress_errors=True)
